                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='readViewer.php?id=". $row['id'] ."' title='Wyświetl' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row1 = mysqli_fetch_array($result1)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                              echo "<a href='readRaportViewer.php?id=". $row1['id_raport'] ."' title='Zobacz Rekord' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
